...
var dataEncodingTestCases = []xmpptest.EncodingTestCase{
	...
	// TODO: find a way to check that any XML syntax errors are passed through.
	// This could be a special error type that causes the tests to compare
	// strings, or we could provide an errors.Is method for *xml.SyntaxError.
	//{
	//	// Check that any XML decoding errors are handled.
	//	Value:     &bin.Data{},
	//	Err:       &xml.SyntaxError{Msg: "element <data> closed by </b>", Line: 1},
	//	XML:       `<data xmlns="urn:xmpp:bob"></b>`,
	//	NoMarshal: true,
	//},
}
