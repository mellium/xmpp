...
var bindTestCases = [...]xmpptest.FeatureTestCase{
	...
	0: {
		...
		Out:        `<iq xmlns="jabber:client" type="result" to="test@example.net" from="example.net" id="123"><bind xmlns="urn:ietf:params:xml:ns:xmpp-bind"><jid>test@example.net/test</jid></bind></iq>`,
	...
	1: {
		...
		Out:        `<iq xmlns="jabber:client" type="result" from="example.net" id="1"><bind xmlns="urn:ietf:params:xml:ns:xmpp-bind"><jid>test@example.net/test</jid></bind></iq>`,
		FinalState: xmpp.Ready,
	},
	2: {
		State:      xmpp.Received,
		...
		Out:        `<iq xmlns="jabber:client" type="result" to="me@example.net" id="2"><bind xmlns="urn:ietf:params:xml:ns:xmpp-bind"><jid>test@example.net/test</jid></bind></iq>`,
		FinalState: xmpp.Ready,
	},
	3: {
		State:      xmpp.Received,
		...
		Out:        `<iq xmlns="jabber:client" type="result" id="123"><bind xmlns="urn:ietf:params:xml:ns:xmpp-bind"><jid>test@example.net/empty</jid></bind></iq>`,
		FinalState: xmpp.Ready,
	},
	4: {
		State:      xmpp.Received,
	...
	5: {
		State:      xmpp.Received | xmpp.S2S,
		Feature:    xmpp.BindCustom(bindFunc),
		In:         `<iq xmlns="jabber:server" type="set" id="123"><bind xmlns="urn:ietf:params:xml:ns:xmpp-bind"/></iq>`,
